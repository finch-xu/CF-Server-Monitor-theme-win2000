...
// 主题不实现登录页：未授权时通知界面弹出「需要登录」对话框，由用户选择是否前往 /admin#admin
const notifyAuthRequired = (baseUrl) => {
  if (typeof window === 'undefined') return
  window.dispatchEvent(new CustomEvent('cfsm-auth-required', { detail: { baseUrl } }))
}
